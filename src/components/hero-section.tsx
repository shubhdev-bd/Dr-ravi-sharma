...
//                 delay: preloaderFinished ? 0.2 : 2.7,
//               }}
//               className="inline-block px-3 py-1.5 md:px-4 md:py-2 bg-accent/10 rounded-full border border-accent/80 backdrop-blur-sm"
//             >
//               <span className="text-accent font-semibold text-xs md:text-sm tracking-wide">
//                 Education Mentor & Guide
//               </span>
...
export default function HeroSection() {
  ...
  return (
    <section
      ...
      className="relative min-h-screen flex items-center overflow-hidden pt-16"
    >
      {/* YouTube Video Background - FIXED z-index to stay behind navbar */}
      ...
      <div className="container mx-auto px-4 py-12 md:py-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center pt-[400px] md:pt-0">
          {/* Left Content - UPDATED COLORS FOR LIGHT BACKGROUND */}
          <motion.div
            initial={{ opacity: 0, x: -50 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8, delay: preloaderFinished ? 0 : 2.5 }}
          ...
          >
            <motion.div
              ...
              className="inline-block px-3 py-1.5 md:px-4 md:py-2 bg-white/80 rounded-full border-2 border-accent backdrop-blur-md shadow-lg"
            >
              <span className="text-accent font-bold text-xs md:text-sm tracking-wide">
                Education Mentor & Guide
              </span>
            </motion.div>
            ...
            <div className="space-y-4 md:space-y-6">
              <motion.h1
                ...
                className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-primary leading-tight drop-shadow-[0_2px_8px_rgba(255,255,255,0.8)]"
              >
                <span className="block mb-2">Hello, I am</span>
                <span className="block text-accent drop-shadow-[0_2px_12px_rgba(14,107,168,0.6)]">
                  {preloaderFinished && (
                    <TypingText text="Dr. Ravi Sharma" delay={0} speed={80} />
                  )}
                </span>
              ...
              <motion.div
                ...
                className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-800 font-medium leading-relaxed max-w-xl min-h-[3rem] md:min-h-[4rem] drop-shadow-[0_1px_4px_rgba(255,255,255,0.9)]"
              >
                {preloaderFinished && (
                  <CyclingTypingText
                    texts={subtitleTexts}
            ...
            >
              <Button
                asChild
                size="lg"
                className="bg-accent hover:bg-accent/90 text-white px-6 py-5 md:px-8 md:py-6 text-sm md:text-base group shadow-2xl border-2 border-accent/50"
              >
                <Link to="/about">
                  Learn About Me
                  <ArrowRight className="ml-2 w-4 h-4 md:w-5 md:h-5 group-hover:translate-x-1 transition-transform" />
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="border-2 border-primary text-primary hover:bg-primary hover:text-white px-6 py-5 md:px-8 md:py-6 text-sm md:text-base bg-white/70 backdrop-blur-md shadow-2xl font-semibold"
              >
                <Link to="/vidyajeevan">Explore Vidyajeevan</Link>
              </Button>
            </motion.div>
